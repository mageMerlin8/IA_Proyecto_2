...
conc_evalua_4(Js,Resp):-
  ...
  write('Numero de manos posibles: '),
  writeln(Tam0),
  writeln('Se van a evaluar 2000 manos(D=4, numFichas > 7).'),nl,
  random_permutation(ManosOp, ManosOpPer),
  primeros_n_ls(ManosOpPer,2000,LsFin),
...
conc_evalua_4(Js,Resp):-
  ...
  evalua_en_4(Js,ManosOp,Movidas,Resp,10),
...
evalua_en_4(Js,Lista,Movidas,Resp,D):-
  lista_fichas_jugador(ManoIA,Js),
  movidas_posibles(ManoIA,Movidas),
  div_4(Lista,L1,L2,L3,L4),
  concurrent(4,[ia_minimax_evalua_conc(Js,Movidas,L1,ManoIA,R1,D),
                ia_minimax_evalua_conc(Js,Movidas,L2,ManoIA,R2,D),
                ia_minimax_evalua_conc(Js,Movidas,L3,ManoIA,R3,D),
                ia_minimax_evalua_conc(Js,Movidas,L4,ManoIA,R4,D)],[]),
...
ia_minimax_evalua_conc(Js,Movidas,L1,ManoIA,LsMovs,D):-
  ia_minimax_evalua(Js,Movidas,L1,ManoIA,_,D),
